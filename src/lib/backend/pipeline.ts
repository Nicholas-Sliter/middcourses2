...
// actually, let's do all the updates in a single transaction

// async function updateCourses(courseObjs: CourseObject[]) {
//     const formattedCourses = courseObjs.map(formatCourse);

//     await upsertCourses(formattedCourses);
...
// async function updateInstructors(courseObjs: CourseObject[]) {

//     const instructorData = courseObjs.map((course) => {
...
//     //check if instructor exist, if not get data from direcotry then insert
...
// async function updateCourseInstructors(semester: string, courseObjs: CourseObject[]) {


//     const courseInstructorData = courseObjs.map((course) => {
//         return course.instructors.map((instructor) => {
//             return {
...
//     await upsertCourseInstructors(courseInstructorData);

//     // eventually want to consider multiple instructors for same class section

//     return;
// }


// async function updateTerms(semester: string, courseObjs: CourseObject[]) {
//     const courseTerms = courseObjs.map((course) => {
//         return {
//             courseID: course.courseNumber,
//             term: semester,
//         }
